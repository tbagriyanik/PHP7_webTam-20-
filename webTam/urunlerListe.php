...
<body>
    ...
    <div class="container mt-5 p-5">
        <div class="row">
            ...
            if(isset($_GET["ara"])) {
                $baglan = mysqli_connect("localhost", "root", "" ,"webtam");
                $sorgu = mysqli_query( $baglan ,"SELECT * FROM urun WHERE urunAdi LIKE '%".$_GET["ara"]."%' OR detay LIKE '%".$_GET["ara"]."%'");
                while($gelen = mysqli_fetch_assoc($sorgu)){
                        ...
                        echo "<p>".$gelen["detay"]."</p>";
                        echo '<a href="index.php">Ana sayfaya dön</a>';
                        echo "</div>";
                }  
                if(mysqli_num_rows($sorgu)==0) {
                    echo '<div class="col-sm-4 p-3"><h3>Böyle bir ürün yoktur...</h3><a href="index.php">Ana sayfaya dön</a></div>';
                }
            } else {
                echo '<div class="col-sm-4 p-3"><h3>Arama yapınız...</h3><a href="index.php">Ana sayfaya dön</a></div>';
            }            
            ?>                        
        </div>
    </div>
