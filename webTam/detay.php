...
<body>
    ...
    <div class="container mt-5 p-5">
        <div class="row">
            ...
            if(isset($_GET["id"])) {
                $baglan = mysqli_connect("localhost", "root", "" ,"webtam");
                $sorgu = mysqli_query( $baglan ,"SELECT * FROM urun WHERE kimlik = ".$_GET["id"]);
                while($gelen = mysqli_fetch_assoc($sorgu)){
                ...
                if(mysqli_num_rows($sorgu)==0) {
                    echo '<div class="col-sm-4 p-3"><h3>Bu ürün yoktur...</h3><a href="index.php">Ana sayfaya dön</a></div>';
                }
            } else {
                echo '<div class="col-sm-4 p-3"><h3>Ürün seçiniz...</h3><a href="index.php">Ana sayfaya dön</a></div>';
            }            
            ?>                        
        </div>
    </div>
